...
public class SimpleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	String sql = "";
    	try{
    		msgPage.append("<br> STEP 2 : Register the JDBC driver");
...
//   		stmt.execute(sql);
    		...
    		msgPage.append("<br> STEP 8 : Deleting the records");
    		...
    		msgPage.append("<br> STEP 10 : clean up the environment");
    		stmt.close();
    		conn.close();
    	...
    	msgPage.append("<br> STEP 11 : Sending steps to HTML ... yowza!");
